...
def run_batsman_run_app():
    ...
    dataset =  pd.read_csv("https://github.com/sharmaji-om/ipl-team-batmans/blob/d0e0d89e6adab8b986d3d42836dd956fc8b88525/ipl_batsmen_current_players_no_team.csv") 
